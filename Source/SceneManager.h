...
public:
	...
	//Set the window size for future use
	void SetWindow(GLFWwindow* window) { m_pWindow = window; }

	//Grab the view manager class
	void SetViewManager(ViewManager* pViewManager) { m_pViewManager = pViewManager; }
...
private:
	...
	//Create a variable to store the windoe size for later use
	GLFWwindow* m_pWindow = nullptr;

	// The variable that stores the connection
